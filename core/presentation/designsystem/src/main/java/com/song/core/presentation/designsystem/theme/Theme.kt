...
/**
 * Keeps the status/navigation bar icons legible against [darkTheme] — the app's own theme
 * choice, not the system's — since edge-to-edge drawing leaves icon color unmanaged otherwise.
 */
@Composable
